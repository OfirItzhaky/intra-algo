...
2. בכל הערכה יש לוודא קיום ובדיקה של:
   ...
   - H (בריאות זרימת כסף): זרימת כספים עקבית פנימה, ללא סימני פיזור חריפים או יציאת כספים משמעותית
...
2. בתוך המגמה – תבנית של נר אחד מעל שני נרות קודמים:
   - נר ראשון ושני יוצרים תיקון/היסוס כלפי מטה או דשדוש.
   - נר שלישי (ה"1") פורץ מעלה וסוגר מעל השיא של שני הנרות הקודמים.
