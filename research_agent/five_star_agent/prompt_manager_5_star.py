...
1. ירידה של כ־50% או יותר מהמחיר הכי גבוה שאליו הגיעה המניה לפי הגרף.
...
"""
# SUMMARY_INTRO = f"""
# ==================== 🖼️ סיכום הגרף מהפנייה הקודמת ====================
#
# הגרף שהועלה קודם לכן הציג את המאפיינים הבאים:
#
# {image_summary}
#
# המשך הניתוח מבוסס על סיכום זה, ואין צורך להעלות מחדש את התמונה כל עוד אין שינוי.
# """
